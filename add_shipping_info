...
window.dataLayer.push({
  event: 'add_shipping_info',              // Nombre del evento. En este caso, siempre debe ser add_shipping_info
  ecommerce: {
    shipping_tier: 'SEUR',              // Nombre del metodo de envío. ESTE PARÁMETRO EN NUEVO                      
    items: [{                           // Comienza una matriz donde se deben incluir todos los productos vistos actualmente
