...
window.dataLayer.push({
  event: 'add_to_wishlist',                 // Nombre del evento. En este caso, siempre debe ser add_to_wishlist
  ecommerce: {                          
    items: [{                           // Comienza una matriz donde se incluira el producto seleccionado
